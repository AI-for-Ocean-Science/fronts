...
c
c     subroutine AVHRR_gac_l2p_v1_GetDateTime(ImageName, Year, Month, 
c     1     YearT, MonthT, Day, Hour, Minute, Second)
c     
c     subroutine AVHRR_gac_l2p_v1_GetGeoFilename(ImageName, YearC, MonthC, 
c     1     GeoNameFull)
c     
c     subroutine AVHRR_gac_l2p_v1_GetSSTOutData( FileNameIn, ConditionedSST, 
c     1     SecondsSince1970)
c     
c     subroutine AVHRR_gac_l2p_v1_CreateOutputSSTFile( FileNameOut, ncOutID, 
c     1     sstIDout, ClearIDout, FrontsIDout, DayOrNightIDout,
c     2     SecondsSinceID, Start, YearC, MonthC, DayC)
c     
c      subroutine AVHRR_gac_l2p_v1_GetGeoData( FileNameIn, LatIn, LonIn, 
...
c     
c***********************************************************************
      subroutine AVHRR_gac_l2p_v1_GetDateTime( ImageName, Year, Month, 
...
c     and do all that, so skip for now.
      ...
      end subroutine AVHRR_gac_l2p_v1_GetDateTime

c***********************************************************************
      subroutine AVHRR_gac_l2p_v1_GetGeoFilename(ImageName, YearC, 
...
c     the SST file. GeoNameFull is used to create the geospatial file.
     ...
     1     'GeoName::', trim(GeoName), '::'
      ...
      end subroutine AVHRR_gac_l2p_v1_GetGeoFilename

c***********************************************************************
      subroutine AVHRR_gac_l2p_v1_GetSSTOutData( FileNameIn, sstOut, 
     1     SecondsSince1970)
c***********************************************************************
c     
...
c     Now clean up.
      ...
      end subroutine AVHRR_gac_l2p_v1_GetSSTOutData

c**********************************************************************
      subroutine AVHRR_gac_l2p_v1_CreateOutputSSTFile( FileNameOut, 
...
c     middle part.
     ...
     5     publisher_url, publisher_institution, cdm_data_type)
      ...
      end subroutine AVHRR_gac_l2p_v1_CreateOutputSSTFile

c***********************************************************************
      subroutine AVHRR_gac_l2p_v1_GetGeoData( FileNameIn, LatIn, LonIn, 
...
c     close the input file.
      ...
      end subroutine AVHRR_gac_l2p_v1_GetGeoData
