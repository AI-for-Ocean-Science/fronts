...
c
c     subroutine AMSRE_v7_l2_GetDateTime(ImageName, Year, Month, 
c     1     YearT, MonthT, Day, Hour, Minute, Second)
c     
c     subroutine AMSRE_v7_l2_GetGeoFilename(ImageName, YearC, MonthC, 
c     1     GeoNameFull)
c     
c     subroutine AMSRE_v7_l2_GetSSTOutData( FileNameIn, ConditionedSST, 
c     1     SecondsSince1970)
c     
c     subroutine AMSRE_v7_l2_CreateOutputSSTFile( FileNameOut, ncOutID, 
c     1     sstIDout, ClearIDout, FrontsIDout, DayOrNightIDout,
c     2     SecondsSinceID, Start, YearC, MonthC, DayC)
c     
c      subroutine AMSRE_v7_l2_GetGeoData( FileNameIn, LatIn, LonIn, 
...
c     
c***********************************************************************
      subroutine AMSRE_v7_l2_GetDateTime( ImageName, Year, Month, 
...
c     and do all that, so skip for now.
      ...
      end subroutine AMSRE_v7_l2_GetDateTime

c***********************************************************************
      subroutine AMSRE_v7_l2_GetGeoFilename(ImageName, YearC, MonthC, 
     1     GeoNameFull)
c***********************************************************************
c     
      implicit none
...
c     the SST file. GeoNameFull is used to create the geospatial file.
     ...
     1     'GeoName::', trim(GeoName), '::'
      ...
      end subroutine AMSRE_v7_l2_GetGeoFilename

c***********************************************************************
      subroutine AMSRE_v7_l2_GetSSTOutData( FileNameIn, sstOut, 
     1     SecondsSince1970)
c***********************************************************************
c     
...
c     Now clean up.
      ...
      end subroutine AMSRE_v7_l2_GetSSTOutData

c**********************************************************************
      subroutine AMSRE_v7_l2_CreateOutputSSTFile( FileNameOut, ncOutID, 
...
c     middle part.
     ...
     1     'Graduate School of Oceanography'
      ...
      ProgVersionNo = AppQual_l2_AMSRE_v7_VersionNo
     ...
     5     publisher_url, publisher_institution, cdm_data_type)
      ...
      end subroutine AMSRE_v7_l2_CreateOutputSSTFile

c***********************************************************************
      subroutine AMSRE_v7_l2_GetGeoData( FileNameIn, LatIn, LonIn, 
...
c     close the input file.
      ...
      end subroutine AMSRE_v7_l2_GetGeoData
